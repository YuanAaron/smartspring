...
import com.smartspring.beans.propertyeditors.CustomBooleanEditor;
import com.smartspring.beans.propertyeditors.CustomNumberEditor;
...
public class SimpleTypeConverter implements TypeConverter {
    ...
    public <T> T convertIfNecessary(Object value, Class<T> requiredType) throws TypeMismatchException {
        ...
        if(ClassUtils.isAssignableValue(requiredType, value)){ //给定的值是否可以直接转换为给定的类型
            return (T)value;
        } else{
